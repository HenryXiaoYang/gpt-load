...
type SystemSettings struct {
	...
	FailoverBodyPhrases          string `json:"failover_body_phrases" name:"config.failover_body_phrases" category:"config.category.key" desc:"config.failover_body_phrases_desc"`
	...
	ChannelRPMLimit              int    `json:"channel_rpm_limit" default:"0" name:"config.channel_rpm_limit" category:"config.category.key" desc:"config.channel_rpm_limit_desc" validate:"required,min=0"`
	ChannelRPMThresholdPercent   int    `json:"channel_rpm_threshold_percent" default:"60" name:"config.channel_rpm_threshold_percent" category:"config.category.key" desc:"config.channel_rpm_threshold_percent_desc" validate:"required,min=1"`
	ChannelRPMRampMinutes        int    `json:"channel_rpm_ramp_minutes" default:"5" name:"config.channel_rpm_ramp_minutes" category:"config.category.key" desc:"config.channel_rpm_ramp_minutes_desc" validate:"required,min=1"`
