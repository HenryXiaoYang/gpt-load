...
type GroupConfig struct {
	...
	FailoverBodyPhrases          *string `json:"failover_body_phrases,omitempty"`
...
type Group struct {
	...
	FailoverBodyPhraseMatcher failover.BodyPhraseMatcher `gorm:"-" json:"-"`
}
...
type APIKey struct {
	...
	Tier         string     `gorm:"column:tier;type:varchar(64);default:''" json:"tier"`
	OpenAITier   string     `gorm:"column:openai_tier;type:varchar(10);default:''" json:"-"`
